...
public class ListagemUf extends javax.swing.JInternalFrame {

    private CadastroUf cadastroUf = new CadastroUf();
    
    public ListagemUf(CadastroUf cadastroUf) {
        this.cadastroUf = cadastroUf;
        initComponents();
        criaTabela();
    }
    ...
    private void jButtonSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarActionPerformed
        try{
            ...
            cadastroUf.preencheUf(getLinha());
            this.dispose();
        }catch(Exception e){
    ...
    private void criaTabela() {
        ...
        try {
            for (Uf uf : dao.getAll()) {
                modelo.addRow(new Object[]{uf.getId(), uf.getNome()});
    ...
    public Uf getLinha() throws BancoException {
